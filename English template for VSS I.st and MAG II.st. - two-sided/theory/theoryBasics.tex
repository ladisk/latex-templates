...
\ref{tab:efficiency_of_processes}, unless the title of the spreadsheet is at the very top
...
Each image (e.g. also the images \ref{fig:some_molecules} and \ref{fig:2_graph}) should
...
% The \citet{} command automatically handles citation with author names, adapting to the number of authors:
\item In 2008, \citet{Bazant_2008} presented
...
repeated in the list of literature (see \ref{sec:literature_samples}
\nameref{sec:literature_samples}), when referring to the same reference again later
...
designed according to the examples in this template (see chapters \ref{sec:literature_samples}
\nameref{sec:literature_samples} and 7 Literature).
...
\subsection{Samples of literature list}\label{sec:literature_samples}
