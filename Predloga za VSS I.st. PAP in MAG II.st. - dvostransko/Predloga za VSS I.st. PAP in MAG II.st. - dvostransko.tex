...
%-----------------------------------
% tukaj se izpolnijo splošna polja o delu (avtor, tip dela, itd.) 

\newcommand{\naslovSlo}{Zasnova predloge za zaključne naloge na Fakulteti za strojništvo}
\newcommand{\naslovAng}{Design for a template for final theses at the Faculty of Mechanical Engineering}

% neustrezen tip dela zakomentirajte
\newcommand{\tipDela}{Magistrsko delo magistrskega študijskega programa II.~stopnje Strojništvo}
%\newcommand{\tipDela}{Diplomsko delo Visokošolskega strokovnega študijskega programa I. stopnje Strojništvo – Projektno aplikativni program}

\newcommand{\avtor}{Janez Novak}
\newcommand{\zagovorMesec}{januar}
\newcommand{\zagovorLeto}{2025}

\newcommand{\mentor}{prof. dr. Franc Horvat, univ. dipl. inž.}
\newcommand{\somentor}{prof. dr. Anton Kovačič, univ. dipl. inž.} % če ni somentorja, pustite to polje prazno

\newcommand{\UDK}{123.45:678.91:234.56(789.1)}
\newcommand{\tekocaStevilka}{MAG II/99}
